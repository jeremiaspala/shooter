    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <select id="role" name="role" class="form-control">
                <option value="visor" <?php echo $user['role'] === 'visor' ? 'selected' : ''; ?>>Visor (solo lectura)</option>
                <option value="admin" <?php echo $user['role'] === 'admin' ? 'selected' : ''; ?>>Admin (acceso completo)</option>
            </select>
        </div>
